...
public interface MessageControllerSwagger {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
            content = @Content(
                    ...
                    examples = @ExampleObject(value = "{\"chatId\": \"f18c1f66-87b4-4eaf-bfdb-c6fd0fb89d7c\", \"content\": \"Hola, necesito ayuda con mi reserva\"}")))
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
            content = @Content(
                    ...
                    examples = @ExampleObject(value = "{\"reason\": \"Contenido ofensivo\"}")))
